...
The Consumer App SDK integrates seamlessly with Cartridge Controller, making it perfect for gaming applications where you want seamless, gasless transactions.
...
The Cartridge Controller is included as a peer dependency of the Consumer App SDK:
...
```typescript
import { StarkSDK, OnboardStrategy, Amount, fromAddress, mainnetTokens } from "x";
