...
Paymasters allow you to sponsor (pay for) transaction fees so users don't have to worry about gas costs. The Consumer App SDK supports two paymaster options depending on your wallet connection strategy.
