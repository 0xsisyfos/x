...
| Path | Purpose |
| --- | --- |
| `src/sdk.ts` | Main SDK orchestration (`StarkSDK`) |
...
| --- | --- | --- |
| `RPC chain mismatch` from `StarkSDK` | `rpcUrl` chain differs from configured `chainId`/network | Align `SDKConfig` values |
